...
team_id INTEGER,
FOREIGN KEY (team_id) REFERENCES team (id) ---sukuria indeksa kaip sasaja laukam (turi buti ne team, o teams)
);
...
---skills siejame su coder skills
...
INSERT INTO "coders" ("f_name", "l_name", "email", "age", "team_id") VALUES ('Tomas', 'Aidietis', 'ta@imone.lt', '35',)
